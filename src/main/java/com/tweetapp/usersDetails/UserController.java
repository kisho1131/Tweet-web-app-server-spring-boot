...
//	register user
  ...
  public ResponseEntity<Void> register(@RequestBody Users user) {
    ...
    URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{loginId}")
        .buildAndExpand(createdUser.getLoginId()).toUri();
...
//	by providing loginId and new password
  ...
  public ResponseEntity<Users> updatePassword(@PathVariable String loginId,
